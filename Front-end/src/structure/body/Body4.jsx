...
const Body4 = () => {
  ...
  return (
    <Box bg={bgColor} color={textColor} p={{ base: 4, md: 8 }} rounded="md">
      <Flex
      ...
      <VStack spacing={6} align="start">
        <Text fontSize={{ base: '16px', md: '18.4px' }} fontWeight={600} mt={8} mb={4}>
          Stay Healthy with Tata 1mg: Your Favourite Online Pharmacy and Healthcare
          Platform
        </Text>
        <Text fontSize={{ base: '16px', md: '18.4px' }} fontWeight={600} mb={4}>
          We Bring Care to Health.
        </Text>
        <Text fontSize={{ base: '14px', md: '16px' }} mb={4} fontWeight={400} color={'#7c7c7c'}>
